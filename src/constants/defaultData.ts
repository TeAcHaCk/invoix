...
export const getDefaultDocument = (): QuotationDocument => ({
  ...
  client: {
    nameOfEvent: 'Walima',
    address: 'Vivek Nagar, Bangalore',
    contactNo: '9686715683',
    clientName: 'Rahul & Ayesha',
    email: 'client@example.com',
  },
  details: {
    invoiceNo: 'QUO-2026-089',
    invoiceDate: getTodayFormattedDate(),
    eventDateMode: 'single',
    eventDate: '03/09/2026',
    eventDateFrom: '03/09/2026',
    eventDateTo: '04/09/2026',
    validUntilDate: '15 Days from quote date',
  },
  packageBannerTitle: 'WALIMA PHOTOGRAPHY & CINEMATOGRAPHY PACKAGE',
  eventCoverage: [
    {
      id: 'day-1',
      dayTitle: 'Day 1 - Walima',
      services: [
  ...
  deliverables: [
    { id: 'del-1', text: 'Event Teaser', included: true },
    { id: 'del-2', text: 'Professionally Edited High Resolution Photographs 100 pics', included: true },
    { id: 'del-3', text: 'Cinematic Highlight Films', included: true },
    { id: 'del-4', text: 'We will provide all the traditional full length video', included: true },
  ],
  pricingItems: [
    {
      id: 'price-1',
      description: 'Complete Package – Walima & Reception Photography & Cinematography',
      amount: 49000,
    },
  ],
